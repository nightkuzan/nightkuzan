...
Full Stack Developer with 3+ years building web products end to end — Vue/Nuxt and React front ends over Node.js back ends (Strapi, NestJS, Koa) on PostgreSQL, MySQL and MongoDB. I've worked across healthcare (hospital information systems), banking and consumer finance, e-learning, and omnichannel customer messaging, in both full-time and freelance roles.

Most of my work sits between product features and the systems underneath them — payment and subscription flows, real-time messaging, data-heavy dashboards, and back-end performance work: load-testing with k6 and fixing what it exposes, whether that's queue fan-out, a missing index or an N+1 query storm.

Currently a Full Stack Developer at Mexty, based in Chiang Mai.
...
<img src="https://img.shields.io/badge/BullMQ-DA2828?style=for-the-badge&logo=redis&logoColor=white" alt="BullMQ" />
...
<img src="https://img.shields.io/badge/LINE_Messaging_API-00C300?style=for-the-badge&logo=line&logoColor=white" alt="LINE Messaging API" />
</div>
